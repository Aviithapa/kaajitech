...
@section('content')
 <!-- page title start -->
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="about-thumb-inner pe-xl-5 me-xl-5">
              <img
                class="animate-img-1 top_image_bounce"
                src="assets/img/about/2.png"
                alt="img"
              />
              <img
                class="animate-img-2 left_image_bounce"
                src="assets/img/about/3.png"
                alt="img"
              />
              <img
                class="animate-img-3 top_image_bounce"
    ...
    <!-- faq area start -->
    <div
      class="faq-area faq-area-margin-top bg-cover pd-top-120 pd-bottom-110"
        ...
        <div class="row pd-top-120">
          <div class="col-lg-5 order-lg-last">
            <div class="about-thumb-inner pt-lg-3">
              ...
              <img
                class="animate-img-bottom-right top_image_bounce"
          ...
          <div class="col-lg-7">
            <div class="section-title mb-0 mt-4 mt-lg-0">
              ...
              <p class="content">
                ...
                bioiiy the end gail designa readable content of a page when
                looking.
              </p>
            </div>
            <div
              class="accordion accordion-inner style-2 accordion-icon-left mt-3"
              id="accordionExample"
            >
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="single-team-inner text-center">
              ...
              <div class="details">
                <h5><a href="case-study-details.html">Devon Lane</a></h5>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-team-inner text-center">
              ...
              <div class="details">
                <h5><a href="case-study-details.html">Darrell Steward</a></h5>
                <p>It Department</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="single-team-inner text-center">
              ...
              <div class="details">
                <h5><a href="case-study-details.html">Bessie Cooper</a></h5>
    ...
    <div
      ...
      style="background-image: url('./assets/img/bg/5.png')"
    >
    ...
    <div class="contact-area">
      <div class="container">
        <div class="contact-inner-1">
          <img
            class="top_image_bounce animate-img-1"
            src="assets/img/banner/2.png"
            alt="img"
          />
          <img
            class="top_image_bounce animate-img-2"
              ...
              <div class="section-title mb-0">
                ...
                <form class="mt-4">
                  <div class="row">
                    ...
                    <div class="col-12">
                      <a
                        class="btn btn-black mt-0 w-100 border-radius-5"
                        href="#"
                        >Submit now</a
                      >
                    </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="single-work-process-inner">
              ...
              <div class="details">
                ...
                <p class="content">
                  Research ipsum dolor sit consec tetur sed diam in the aliquam
                  tempor
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="single-work-process-inner">
              ...
              <div class="details">
                ...
                <p class="content">
                  Develope ipsum dolor sit consec tetur sed diam in the aliquam
                  tempor
                </p>
              </div>
            </div>
